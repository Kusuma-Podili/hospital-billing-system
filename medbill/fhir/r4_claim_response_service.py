"""
MedBill Enterprise - HL7 FHIR R4 ClaimResponse Adjudication Resource Service
"""
...
class FHIRClaimResponseService:
    """Service for HL7 FHIR R4 ClaimResponse Adjudication Resource Service."""
    def __init__(self):
