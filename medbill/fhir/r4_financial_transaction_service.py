"""
MedBill Enterprise - HL7 FHIR R4 Financial Transaction Resource Service
"""
...
class FHIRFinancialTransactionService:
    """Service for HL7 FHIR R4 Financial Transaction Resource Service."""
    def __init__(self):
