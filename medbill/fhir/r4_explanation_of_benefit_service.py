"""
MedBill Enterprise - HL7 FHIR R4 ExplanationOfBenefit (EOB) Remittance Service
"""
...
class FHIRExplanationOfBenefitService:
    """Service for HL7 FHIR R4 ExplanationOfBenefit (EOB) Remittance Service."""
    def __init__(self):
