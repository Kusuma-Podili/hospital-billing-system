"""
MedBill Enterprise - General Ledger Financial Statement & Audit Reporter
"""
...
class GeneralLedgerReporter:
    """Enterprise engine for General Ledger Financial Statement & Audit Reporter."""
    def __init__(self):
