"""
MedBill Enterprise - HIPAA X12 EDI 835 Electronic Remittance Advice (ERA) Parser
"""
...
class EDI835Parser:
    """Enterprise engine for HIPAA X12 EDI 835 Electronic Remittance Advice (ERA) Parser."""
    def __init__(self):
        self.records: Dict[str, EDI835ParserRecord] = {}
